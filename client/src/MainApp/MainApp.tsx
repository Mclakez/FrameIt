...
export default function MainApp({uploadedImage, setUploadedImage, logoImage, setLogoImage, drawCanvas, canvasRef, setOverlayPosition, overlayPosition, selectedImage, setSelectedImage, showBrandModal, setShowBrandModal, brandCards, setBrandCards, userName}: MainAppProps) {
